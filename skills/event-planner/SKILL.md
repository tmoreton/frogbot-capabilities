---
name: event-planner
description: Build a shared event plan with decisions, owners, timing, costs, and a live checklist.
---

# Event Planner

Use this skill for gatherings that require coordination across people, timing, tasks, or money.

1. Confirm the event purpose, attendees, date window, location, budget, accessibility needs, and success criteria.
2. Identify decisions in dependency order: date, venue, format, food, logistics, and communication.
